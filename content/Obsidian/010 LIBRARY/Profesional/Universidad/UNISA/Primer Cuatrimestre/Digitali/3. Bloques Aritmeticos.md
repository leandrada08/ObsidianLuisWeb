...
- Sumadores de N bits
	...
	- Condiciona
- Multiplicaciones
	- Generacion de productos parciales
		- Anding
		- Booth
	- Reduccion de productos parciales
		- Carry save
		- Dual save
		- Wallace tree
		- Dada tre
	- Suma final
		- CPA
- Multiplicadores signados
	- Vector de correcion
	- Digito canonico
- Multiplicacion con constantes
	- Aritmetica distribuida → Rom
...
### Sommatori di base #tarjeta-anki 
#### Half Adders
Circuito combinazionale utilizzato per sommare 2 bit $a_i$ e $b_i$, senza un carry in ingresso: $$s_i = a_i \bigoplus b_i$$$$c_i = a_i b_i$$
#### Full adders
Un sommatore di 3 bit, chiamato anche compressore 3 a 2: $$s_i = a_i \bigoplus b_i \bigoplus c_i$$$$c_{i+1} = (a_i \bigoplus b_i) c_i \bigoplus a_i b_i$$- Queste strutture vengono implementate in modo diverso a seconda dello strumento e dell'hardware.
...
### Diversi tipi di sommatori di N bit #tarjeta-anki 
...
### Ripple carry adders (RCA) #tarjeta-anki 
...
### Block Generate e Block Propagate #tarjeta-anki 
...
### Carry Skip Adder/Carry Bypass Adder #tarjeta-anki 
...
- Quando analizziamo il ritardo del BP in un blocco di i bit, ci rendiamo conto che il ritardo cresce linearmente con i. $$L(i) = (i-1)\frac{t_{mux}}{t_{a}} + L(0)$$- Quando analizziamo il ritardo della somma, ci rendiamo conto che è la stessa espressione, solo che con una relazione decrescente. $$L(i) = (p-i)\frac{t_{mux}}{t_{a}} + L(p)$$- La soluzione ottimale è blocchi centrali più lunghi e blocchi estremi più corti.
![[Pasted image 20231108130345.png]]
^1721665184280



### Carry Look-Ahead Adder (CLA) #tarjeta-anki 
...
### Carry Select Adder (CSA) #tarjeta-anki 
...
### Sommatore condizionale #tarjeta-anki 
...
## Sommatori Carry Save e Compressori #tarjeta-anki 
...
- L'albero di compressione è il primo blocco di costruzione per ridurre i requisiti del numero di CPA per la som
^1721665184300
...
#### Trasformazioni per operazioni di somma e moltiplicazione #tarjeta-anki 
...
#### Trasformazioni per cascata di moltiplicazioni #tarjeta-anki 
...
### Implementare la sottrazione con il circuito della somma #tarjeta-anki 
...
### Sommatore di 4 numeri di 4 bit ottimizzato in velocità
...
### Sommatore ottimizzato al massimo in risorse
...
## Multiplicatori Paralleli #tarjeta-anki 
...
#### Moltiplicatore di Booth #tarjeta-anki 
...
### Riduzione dei Prodotti Parziali #tarjeta-anki 
...
#### Riduzione Carry Save #tarjeta-anki 
...
#### Riduzione Dual Carry Save #tarjeta-anki 
...
#### Riduzione ad Albero di Wallace #tarjeta-anki 
...
![[Pasted image 20240219094950.png|400]] ![[Pasted image 20240219095012.png|400]]
- Ogni livello del sommatore possiede un ritardo di FA nel suo percorso.
![[Pasted image 20240219101705.png]]
^1721665184332


#### Riduzione ad Albero di Dadda #tarjeta-anki 
...
### Eliminazione dell'Estensione del Segno #tarjeta-anki 
#### Introduzione
...
### Digit Canonico con Segno #tarjeta-anki 
...
## Moltiplicazione per Costanti #tarjeta-anki 
...
## Operazioni con Barrel Shifter #tarjeta-anki 
...
## Aritmetica Distribuita #tarjeta-anki 
